...
self.AddMomentAttributes(moment,moment_e,['id','goto','clear']);moment_e.querySelectorAll(':scope > *').forEach(async(element_e)=>{switch(element_e.tagName){case'text':moment.Elements.push(SutoriElementText.Parse(element_e));break;case'option':moment.Elements.push(SutoriElementOption.Parse(element_e));break;case'image':moment.Elements.push(SutoriElementImage.Parse(element_e));break;case'audio':moment.Elements.push(SutoriElementAudio.Parse(element_e));break;case'video':moment.Elements.push(SutoriElementVideo.Parse(element_e));break;case'load':const loader=SutoriElementLoad.Parse(element_e);if(loader.LoadMode==SutoriLoadMode.Immediate){await self.AddDataFromXmlUri(loader.Path);loader.Loaded=true;}
